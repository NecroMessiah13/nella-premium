...
["02","Курьер","Доставим курьером в любой город России. Бесплатно, 1–5 дней."],
["03","Почта России","Отправляем по почтовому индексу в любую точку страны. От 300 ₽, 5–7 рабочих дней."],
["04","СДЭК","Точная стоимость по тарифу СДЭК — до пункта выдачи или до двери. Рассчитывается при оформлении."]
